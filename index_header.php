...
<body>
  <header>
    <div class="logo">
      <a href="index.php"><span class="em">GROW</span>
    ...
    <div class="user-box" style="display: flex; align-items:center;">
      <a class="Btn" href="search_trees.php"><img style="height:30px;" src="./images/sea2.png" alt=""></a>
      <?php if (isset($_SESSION['user_name'])) {
        echo ' <img style="height:40px; margin-left:10px ;" src="images/usericon1.png" class="user-pic" onclick="toggleMenu()" />';
      } else {
